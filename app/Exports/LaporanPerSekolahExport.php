...
class LaporanPerSekolahExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    ...
    protected $sekolahs_id;

    public function __construct($sekolahs_id)
    {
        $this->sekolahs_id = $sekolahs_id;
    }
    ...
    public function collection()
    {
        return Bantuan::with(['sekolah', 'databantuan'])
                        ...
                        ->where('bantuans.sekolahs_id', $this->sekolahs_id)
                        ->get();
    }
