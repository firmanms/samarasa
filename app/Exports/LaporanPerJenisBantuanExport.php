...
class LaporanPerJenisBantuanExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    ...
    protected $databantuans_id;

    public function __construct($databantuans_id)
    {
        $this->databantuans_id = $databantuans_id;
    }
    ...
    public function collection()
    {
        return Bantuan::with(['sekolah', 'databantuan'])
                        ...
                        ->where('bantuans.databantuans_id', $this->databantuans_id)
                        ->get();
    }
